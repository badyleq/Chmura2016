 ...
 * @see http://www.classmarker.com/online-testing/api/developers
 * @version 1
 ...
 *     See: http://www.classmarker.com/online-testing/api/developers/#getgroups
 *
 ...
 *     See: http://www.classmarker.com/online-testing/api/developers/ for more details
 *
 ...
 *
 * See: http://www.classmarker.com/online-testing/api/developers/#explain
 */
...
if ($response_format=='xml'){
	...
	if ( $results->status == 'error' ){
		 ...
		 *
		 * See error codes:
		 * http://www.classmarker.com/online-testing/api/developers#errorcodes
		 *
		 * */
